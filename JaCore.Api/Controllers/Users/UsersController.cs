...
public class UsersController : ControllerBase
{
    ...
    // GET: api/v1/users/{id}
    [HttpGet(ApiConstants.UserEndpoints.ById)] // Changed GetById to ById
    ...
    // PUT: api/v1/users/{id}
    [HttpPut(ApiConstants.UserEndpoints.ById)] // Changed GetById to ById
    ...
    [HttpDelete(ApiConstants.UserEndpoints.ById)] // Changed GetById to ById
    [Authorize(Policy = ApiConstants.Policies.AdminOnly)] // Use policy constant
    [ProducesResponseType(StatusCodes.Status204NoContent)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status400BadRequest)]
